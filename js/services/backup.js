...
import { deserializeBackupRows, serializeBackupRows } from './backup-serialization.js?v=20260813-cashbook-amount-v15';
import { mapWithConcurrency } from '../domain/async-pool.js?v=20260813-cashbook-amount-v15';
import { 
  supabaseClient, 
  isCloudActive,
  tableProductsName,
