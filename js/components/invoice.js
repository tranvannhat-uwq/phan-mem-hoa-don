...
import { dbSaveOrder, dbCreateQuickCustomer, dbConfirmOrder, dbAmendOrder, dbFetchOrderDebtSnapshot, dbLoadCustomerAssignedPricing, dbRefreshCustomerFinancialState, dbRefreshOrderById, cacheOrdersLocally, isCloudActive } from '../services/supabase.js?v=20260901-order-amend-v26';
import { renderAll, switchTab } from '../main.js?v=20260901-order-amend-v26';
import { populatePricelistsDropdowns } from './pricelists.js';
import { generateUniqueCustomerCode } from './customers.js?v=20260901-order-amend-v26';
...
import { isPrintOnlyPriceList, parseInvoicePercent, requiresOrderSaveApproval, sanitizeInvoicePercentInput, supportsInvoiceLineDiscount } from '../domain/invoice-discount.js?v=20260901-order-amend-v26';
...
import { chargeCustomerDebt, getOrderDebtSnapshot, getOrderOutstandingAmount } from '../domain/customer-debt.js?v=20260901-order-amend-v26';
  ...
  try {
    ...
    if (saved) {
      ...
      if (amendOrderId) {
        ...
        resetInvoiceBuilder();
        renderAll();
        showToast(`Đã cập nhật trực tiếp đơn ${persistedOrder.id}. Mã đơn và thời gian ban đầu được giữ nguyên.`, 'success');
