...
import { dbSaveOrder, dbCreateQuickCustomer, dbConfirmOrder, dbAmendOrder, dbFetchOrderDebtSnapshot, dbLoadCustomerAssignedPricing, dbRefreshCustomerFinancialState, dbRefreshOrderById, cacheOrdersLocally, isCloudActive } from '../services/supabase.js?v=20260918-customer-debt-invariant-v2';
import { renderAll, switchTab } from '../main.js?v=20260918-customer-debt-invariant-v2';
import { populatePricelistsDropdowns } from './pricelists.js?v=20260918-customer-debt-invariant-v2';
import { generateUniqueCustomerCode } from './customers.js?v=20260918-customer-debt-invariant-v2';
import { addCashbookTransaction } from './so_quy.js?v=20260918-customer-debt-invariant-v2';
import { getApplicablePriceList, resolveCustomerProductPrice, normalizePriceListType, PRICE_LIST_TYPES, filterPriceListsForUser, canUserViewPriceList, canUserUsePriceListForCustomer, isDealerPrivatePriceList, isUsableResolvedPrice, shouldOverrideWithGlobalCustomerPriceList } from '../domain/pricing.js?v=20260918-customer-debt-invariant-v2';
import { normalizeCustomerPhone } from '../domain/customer-query.js';
import { isPrintOnlyPriceList, parseInvoicePercent, requiresOrderSaveApproval, sanitizeInvoicePercentInput, supportsInvoiceLineDiscount } from '../domain/invoice-discount.js?v=20260918-customer-debt-invariant-v2';
...
import { chargeCustomerDebt, getOrderDebtSnapshot, getOrderOutstandingAmount } from '../domain/customer-debt.js?v=20260918-customer-debt-invariant-v2';
import { getOrderDisplayCode } from '../domain/order-display.js';
import { canAdjustOrderBusinessDate, currentBusinessDateTimeInputValue, resolveOrderBusinessDateTimeForSave } from '../domain/order-business-date.js?v=20260918-customer-debt-invariant-v2';
