...
import { dbSaveOrder, dbCreateQuickCustomer, dbConfirmOrder, dbAmendOrder, dbFetchOrderDebtSnapshot, dbLoadCustomerAssignedPricing, dbRefreshCustomerFinancialState, dbRefreshOrderById, cacheOrdersLocally, isCloudActive } from '../services/supabase.js?v=20260811-realtime-egress-v9';
import { renderAll, switchTab } from '../main.js?v=20260811-realtime-egress-v9';
import { populatePricelistsDropdowns } from './pricelists.js';
import { generateUniqueCustomerCode } from './customers.js?v=20260811-realtime-egress-v9';
import { addCashbookTransaction } from './so_quy.js?v=20260811-realtime-egress-v9';
...
import { isPrintOnlyPriceList, requiresOrderSaveApproval, supportsInvoiceLineDiscount } from '../domain/invoice-discount.js?v=20260811-realtime-egress-v9';
