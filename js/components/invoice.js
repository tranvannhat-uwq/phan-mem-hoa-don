...
import { dbSaveOrder, dbCreateQuickCustomer, dbConfirmOrder, dbAmendOrder, dbFetchOrderDebtSnapshot, dbLoadCustomerAssignedPricing, dbRefreshCustomerFinancialState, dbRefreshOrderById, cacheOrdersLocally, isCloudActive } from '../services/supabase.js?v=20260915-payroll-product-group-v1';
import { renderAll, switchTab } from '../main.js?v=20260915-payroll-product-group-v1';
import { populatePricelistsDropdowns } from './pricelists.js?v=20260915-payroll-product-group-v1';
import { generateUniqueCustomerCode } from './customers.js?v=20260915-payroll-product-group-v1';
import { addCashbookTransaction } from './so_quy.js?v=20260915-payroll-product-group-v1';
import { getApplicablePriceList, resolveCustomerProductPrice, normalizePriceListType, PRICE_LIST_TYPES, filterPriceListsForUser, canUserViewPriceList, canUserUsePriceListForCustomer, isDealerPrivatePriceList, isUsableResolvedPrice, shouldOverrideWithGlobalCustomerPriceList } from '../domain/pricing.js?v=20260915-payroll-product-group-v1';
import { normalizeCustomerPhone } from '../domain/customer-query.js';
import { isPrintOnlyPriceList, parseInvoicePercent, requiresOrderSaveApproval, sanitizeInvoicePercentInput, supportsInvoiceLineDiscount } from '../domain/invoice-discount.js?v=20260915-payroll-product-group-v1';
...
import { chargeCustomerDebt, getOrderDebtSnapshot, getOrderOutstandingAmount } from '../domain/customer-debt.js?v=20260915-payroll-product-group-v1';
