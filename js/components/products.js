...
import { dbSaveProductsBulk, dbDeleteProduct } from '../services/supabase.js?v=20260803-customer-toolbar-layout1';
    ...
    <tr class="product-variant-editor-row" data-variant-id="${id}">
      ...
      <td>
        <select class="form-control variant-package-input" required>
          ...
          ${['Thùng', 'Lon', 'Hộp', 'Bao', 'Túi', 'Chai', 'Gói', 'Kg', 'Lít'].map(value =>
