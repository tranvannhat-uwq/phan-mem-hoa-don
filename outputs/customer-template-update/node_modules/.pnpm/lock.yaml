  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz':
    resolution: {integrity: sha512-wq2uuW7GSOBEjzFEW2Dm0gqotQ07N4/HdePUPho9KRuTSyyKO1MHbrdvHuB/4lo3y4Xrv70PYbK+QstZ0xk9wg==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz}
    version: 2.8.31
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
