  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.33.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.33.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.33.tgz':
    resolution: {integrity: sha512-4c2SpNNLIWg9lCE7m+LlbuL52KqV+TqYk7AmF84dggaEvORkO2DYecbLDTHANhu2IkOmKzUQPVm9KGrODUB8pQ==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.33.tgz}
    version: 2.8.33
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
