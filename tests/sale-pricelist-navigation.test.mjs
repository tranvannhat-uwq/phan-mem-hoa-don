...
test('sale navigation hides the price-list management page', () => {
  ...
  assert.match(main, /state\.currentUser\?\.role === 'sale' && panelId === 'pricelists-panel'[\s\S]{0,100}panelId = 'invoice-panel'/);
});
